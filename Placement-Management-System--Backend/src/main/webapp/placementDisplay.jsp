...
<body>
    ...
    <div align="center" class="table">
        ...
        <h2>List of Placements</h2>
            ...
            <c:forEach var="placement" items="${findAllPlacement}">
                <tr>
                    ...
                    <td>
                    	<a href="editPlacement?id=${placement.id}"><button type="button"
			class="btn btn-warning">Edit</button></a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deletePlacement?id=${placement.id}"><button type="button"
    ...
    <br>
        <h2 align="center">
        	<a href="placementIndex.jsp"><button type="button"
