...
<body>
    ...
    <div align="center" class="table">
       ...
       <h2>List of Colleges</h2>
            ...
            <c:forEach var="college" items="${findAllCollege}">
                <tr>
                    ...
                    <td>
                    	<a href="editCollege?id=${college.id}"><button type="button"
			class="btn btn-warning">Edit</button></a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deleteCollege?id=${college.id}"><button type="button"
    ...
    <h2 align="center">
        	<a href="collegeIndex.jsp"><button type="button"
