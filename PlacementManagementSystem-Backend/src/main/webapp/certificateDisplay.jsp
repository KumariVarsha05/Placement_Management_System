...
<body>
	...
	<div align="center"  class="table">
		<table border="1" cellpadding="5" class="table-bodered">
			...
			<c:forEach var="certificate" items="${findAllCertificate}">
				<tr>
					<td><c:out value="${certificate.id}" /></td>
					<td><c:out value="${certificate.year}" /></td>
					<td><c:out value="${certificate.college}" /></td>
					<td><a
						href="editCertificate?id=${certificate.id}"><button type="button"
			class="btn btn-warning">Edit</button></a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a
						href="deleteCertificate?id=${certificate.id}"><button type="button"
	...
	<h2 align="center">
			<a href="certificateIndex.jsp"><button type="button"
