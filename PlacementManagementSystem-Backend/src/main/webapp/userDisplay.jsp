...
<body>
    ...
    <div align="center">
        <table border="1" cellpadding="5">
         <h2>List of Users</h2>
            ...
            <c:forEach var="user" items="${findAllUser}">
                <tr>
                    ...
                    <td>
                    	<a href="editUser?id=${user.id}"><button type="button"
			class="btn btn-warning">Edit</button></a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deleteUser?id=${user.id}"><button type="button"
    ...
    <br>
        <h2 align="center">
        	<a href="userIndex.jsp"><button type="button"
